...
const Stepper = () => {
  ...
  return (
    <div
      className={`font-mono -tracking-wider my-4 border border-gray-200 rounded-lg p-6 ${
        theme === "dark" ? "text-[#59636e] bg-black" : "text-black bg-white"
      }`}
    >
      <TitleComponent title="Work Experience" />

      <div className="md:left-8 top-2">
        {WORKEXPERIENCES.map((exp) => {
          ...
          return (
            ...
            >
              ...
              {/* {!isSmallScreen && (
                <div
                  className={`font-mono -tracking-widest w-8 h-8 flex items-center justify-center rounded-full border-2 z-10  ${
              ...
              {/* Experience Details */}
              <div
                className={`truncate max-w-max p-2 ${
                  theme === "dark"
                    ? "text-white bg-black"
                    : "text-black bg-white"
                }`}
              >
                ...
                >
                  {exp.tech.map((tech) => (
                    <span
                      key={tech}
                      className="border-[1px] p-2 mt-2 rounded-md mr-2"
                    >
                      {tech}
                    </span>
                  ))}

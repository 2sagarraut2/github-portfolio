  ...
  return (
    <div>
      <header className="App-header">
        <div
          className={`flex p-2 justify-between pt-4 ${
        ...
        >
          <div className="flex">
            ...
            >
              <button
                className={`rounded-lg border-[1px] border-gray-200 px-2 py-2 text-sm hover:bg-[#ebeef1] fill-current ${
                  theme === "dark"
              ...
              >
                <svg
                  ...
                  className="octicon octicon-three-bars Button-visual fill-current"
                >
            ...
            <div className="mx-2 flex">
              <Link to="/">
                <button
                  className={`border-gray-200 text-sm rounded-lg fill-current ${
                ...
                >
                  <svg
                    ...
                    width="32"
                    data-view-component="true"
                    className="octicon octicon-mark-github v-align-middle fill-current"
                  >
